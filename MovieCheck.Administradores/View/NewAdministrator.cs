...
{
    public partial class NewAdministrator : Form
    {
            ...
            try
            {
                ...
                using (var contexto = new MovieCheckContext())
                {
                    ...
                    if (this.DddFixo.Text.ToString() != string.Empty)
                    {
                        ...
                        {
                            administrador.AdicionarTelefone(contexto.Telefone.Where(t => t.Tipo == 0 && t.Ddd == fixoNovo.Ddd && t.Numero == fixoNovo.Numero).FirstOrDefault());
                        }
                        else
                        {
                            administrador.AdicionarTelefone(fixoNovo);
                        }
                    }
                    ...
                    if (this.DddCelular.Text.ToString() != string.Empty)
                    {
                        ...
                        {
                            administrador.AdicionarTelefone(contexto.Telefone.Where(t => t.Tipo == 1 && t.Ddd == celularNovo.Ddd && t.Numero == celularNovo.Numero).FirstOrDefault());
                        }
                        else
                        {
                            administrador.AdicionarTelefone(celularNovo);
                        }
                    }

                    contexto.Cliente.Add(administrador);
                    contexto.SaveChanges();

                    mensagem = "Novo administrador cadastrado com sucesso.";
                ...
                if (Cliente.IsEmail(this.Email.Text.ToString()))
                {
                    ...
                    if (Usuario.IsNumeric(this.Cpf.Text.ToString()))
                    {
                        ...
                        if (Endereco.IsNumeric(this.EnderecoCep.Text.ToString()))
                        {
                            ...
                            {
                                var administrador = new Cliente()
                                {
                                    Email = this.Email.Text.ToString(),
                                    Nome = this.Nome.Text.ToString(),
                                    Status = 1,
                                    Cpf = (this.Cpf.Text.ToString() != string.Empty ? this.Cpf.Text.ToString() : ""),
                                    Tipo = 1
                                };
                                ...
                                {
                                    administrador.Endereco = new Endereco()
                                    {
                                ...
                                if (administrador.Cpf != string.Empty)
                                {
                                    VerificaCpf(administrador.Cpf);
                                }

                                CadastroUsuario.ValidaSenha(this.Senha.Text.ToString(), this.SenhaConfirma.Text.ToString());
                                VerificaEmail(administrador.Email);
